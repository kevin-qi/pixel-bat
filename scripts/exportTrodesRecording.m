...
%EXPORTTRODESRECORDING Export data from Trodes recording
%   path_to_rec_dir : Path to directory containing .rec file
%       Recording directory must have default name generated by trodes: 
%       (YYYYMMDD_HHMMSS.rec)
%   path_to_trodes : Path to directory containing Trodes software
%   varargin : flags to determine which data streams to extract
...
if(exist(path_to_rec_file))
    ...
    disp(cmd)
    [status, cmdout] = system(cmd); % Run export command
    disp(cmdout)
